...
import ReturnExp2Sim from "@/app/preview/ReturnExp2Sim";
        ...
        >
          ...
          >
            ...
            personaId === "return-exp1" ? (
              <ReturnExp1Sim />
            ) : /* Return exp2: chat-first advisor — cosimo leads with a daily brief,
                   and the cards are generated by the conversation. */
            personaId === "return-exp2" ? (
              <ReturnExp2Sim />
