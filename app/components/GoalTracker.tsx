...
import {
  ...
  UTILITY_NEGATIVE,
  BG_PRIMARY, BG_SHEET, TEXT_PRIMARY, OUTLINE_SUBTLE, OUTLINE_BOLD, MAIN_PRIMARY_SUBTLE,
} from "../lib/colors";
    ...
    <div style={{ position: "relative" }}>
      <button
        ...
        style={{
          width: 48,
          height: 48,
          // Frosted = matches the close-X chip on the other side of the app bar: solid BG_SHEET fill
          // (white in light, opaque lifted in dark — BG_CARD is a 5% white wash in dark), bold outline, card shadow.
          backgroundColor: frosted ? BG_SHEET : BG_PRIMARY,
