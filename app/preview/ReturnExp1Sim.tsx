    ...
    return (
      ...
      >
        ...
        {ambient && pid === "home" && (
          ...
          >
            <div data-ambient-art style={{ position: "absolute", left: 0, right: 0, top: 0, height: isMobile ? "100%" : "var(--re1-amb-scene-img-h, 100%)", backgroundImage: `var(--re1-amb-scene-scrim, linear-gradient(transparent, transparent)), ${isMobile ? "var(--re1-amb-scene-mobile, var(--re1-amb-scene))" : "var(--re1-amb-scene)"}`, backgroundSize: isMobile ? "cover" : "var(--re1-amb-scene-size, cover)", backgroundPosition: isMobile ? "bottom center" : "var(--re1-amb-scene-pos, bottom center)", backgroundRepeat: "no-repeat", WebkitMaskImage: isMobile ? "linear-gradient(180deg, #000 60%, transparent 100%)" : "var(--re1-amb-scene-mask, none)", maskImage: isMobile ? "linear-gradient(180deg, #000 60%, transparent 100%)" : "var(--re1-amb-scene-mask, none)" }} />
