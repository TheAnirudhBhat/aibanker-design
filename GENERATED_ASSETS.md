...
| public/return-exp1/ambient/variants/gen_slice-slate-light.webp | Ground · slice · slate, light — a sky crown drifting to periwinkle at the right, pure white by the second card; 540×1170 (the frame's aspect), top-anchored cover-fit, pinned, never scrolls | none (DLS tints; user pins "mesh at the top fading to white", "muddy", "gradient lines") | scripts/slice-mesh.cjs (OKLab B-spline mesh, random-rounding dither; not image_gen) | 2026-09-24 | active prototype |
