...
| public/return-exp1/ambient/variants/gen_slice-duo-light.webp | Ground · slice · duo, light — a mesh crown: Valentino pink (left) and slice blue (right) bloom out of a lilac top edge, pure white by the second card; 540×1170 (the frame's aspect), top-anchored cover-fit, pinned, never scrolls | none (DLS tints; user pins "mesh at the top fading to white", "muddy", "gradient lines") | scripts/slice-mesh.cjs (OKLab B-spline mesh, random-rounding dither; not image_gen) | 2026-09-24 | active prototype |
| public/return-exp1/ambient/variants/gen_slice-duo-dark.webp | Ground · slice · duo, dark — the same crown by night: a plum edge (left) on navy out of a navy top edge, pure black by the second card; 540×1170 (the frame's aspect), top-anchored cover-fit, pinned, never scrolls | none (DLS tints; user pins "mesh at the top fading to white", "muddy", "gradient lines") | scripts/slice-mesh.cjs (OKLab B-spline mesh, random-rounding dither; not image_gen) | 2026-09-24 | active prototype |
