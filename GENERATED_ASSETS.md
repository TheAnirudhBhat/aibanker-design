...
| public/return-exp1/ambient/variants/gen_revbg-haze-light.webp | Ground & cards · Indigo haze, light — Revolut's analytics page — charcoal with an indigo haze across the top and faint blue-grey drift below by night; periwinkle over cool off-white by day; full-screen 2:3, pinned, never scrolls | Revolut home/analytics screens (palette, mood); gen_scene-aurora-mobile-light (restraint) | codex image_gen | 2026-09-24 | archived — cut on user pin 2026-09-24 ("trash") |
| public/return-exp1/ambient/variants/gen_revbg-haze-dark.webp | Ground & cards · Indigo haze, dark — Revolut's analytics page — charcoal with an indigo haze across the top and faint blue-grey drift below by night; periwinkle over cool off-white by day; full-screen 2:3, pinned, never scrolls | Revolut home/analytics screens (palette, mood); gen_scene-aurora-mobile-dark (restraint) | codex image_gen | 2026-09-24 | archived — cut on user pin 2026-09-24 ("trash") |
| public/return-exp1/ambient/variants/gen_slice-mesh-dark.webp | Ground · slice, dark — a smooth grey mesh gradient on pure black: grey ribbons sweep down the page with black pockets between them, up to 14% white; full-screen 2:3, cover-fit, pinned, never scrolls | none (drawn from the user's pins: "a mesh gradient", "pure blacks and very subtle grays") | scripts/slice-mesh.cjs (bicubic mesh over a grey grid, gently warped; not image_gen) | 2026-09-24 | archived — replaced 2026-09-24 by the three slice sets below |
| public/return-exp1/ambient/variants/gen_slice-duo-light.webp | Ground · slice · duo, light — a mesh crown: Valentino pink (left) and slice blue (right) bloom out of a lilac top edge, pure white by the second card; 540×1170 (the frame's aspect), top-anchored cover-fit, pinned, never scrolls | none (DLS tints; user pins "mesh at the top fading to white", "muddy", "gradient lines") | scripts/slice-mesh.cjs (OKLab B-spline mesh, random-rounding dither; not image_gen) | 2026-09-24 | archived — cut on user pin 2026-09-24 ("remove slice duo from ground") |
| public/return-exp1/ambient/variants/gen_slice-duo-dark.webp | Ground · slice · duo, dark — the same crown by night: a plum edge (left) on navy out of a navy top edge, pure black by the second card; 540×1170 (the frame's aspect), top-anchored cover-fit, pinned, never scrolls | none (DLS tints; user pins "mesh at the top fading to white", "muddy", "gradient lines") | scripts/slice-mesh.cjs (OKLab B-spline mesh, random-rounding dither; not image_gen) | 2026-09-24 | archived — cut on user pin 2026-09-24 ("remove slice duo from ground") |
| public/return-exp1/ambient/variants/gen_slice-lilac-light.webp | Ground · slice · lilac, light — one violet as a mesh crown, warm at the left and cool at the right, softer and a little deeper; 540×1170 (the frame's aspect), top-anchored cover-fit, pinned, never scrolls | none (DLS tints; user pins "mesh at the top fading to white", "muddy", "gradient lines") | scripts/slice-mesh.cjs (OKLab B-spline mesh, random-rounding dither; not image_gen) | 2026-09-24 | active prototype |
| public/return-exp1/ambient/variants/gen_slice-lilac-dark.webp | Ground · slice · lilac, dark — the same violet crown as aubergine on pure black; 540×1170 (the frame's aspect), top-anchored cover-fit, pinned, never scrolls | none (DLS tints; user pins "mesh at the top fading to white", "muddy", "gradient lines") | scripts/slice-mesh.cjs (OKLab B-spline mesh, random-rounding dither; not image_gen) | 2026-09-24 | active prototype |
| public/return-exp1/ambient/variants/gen_slice-slate-light.webp | Ground · slice · slate, light — Silver · soft (finalised 2026-09-24, "finalise silver soft"): a barely-there cool silver crown, pure white by the second card; the sky crown it replaced and the Slate by day trial sets are in git history; 540×1170 (the frame's aspect), top-anchored cover-fit, pinned, never scrolls | none (DLS tints; user pins "mesh at the top fading to white", "muddy", "gradient lines") | scripts/slice-mesh.cjs (OKLab B-spline mesh, random-rounding dither; not image_gen) | 2026-09-24 | active prototype |
| public/return-exp1/ambient/variants/gen_slice-slate-dark.webp | Ground · slice · slate, dark — a slate crown on pure black (the round the user approved: "d3 dark slice cards bg looks good"); 540×1170 (the frame's aspect), top-anchored cover-fit, pinned, never scrolls | none (DLS tints; user pins "mesh at the top fading to white", "muddy", "gradient lines") | scripts/slice-mesh.cjs (OKLab B-spline mesh, random-rounding dither; not image_gen) | 2026-09-24 | active prototype |
| public/return-exp1/ambient/variants/gen_slice-aurora-light.webp | Ground · slice · aurora, light — a full-screen mesh on the Galaxy's lilac white: a lilac crown with pink at the left and aqua at the right, aqua down the left edge, pink down the right, a lilac bloom at the foot; 540×1170 (the frame's aspect), top-anchored cover-fit, pinned, never scrolls | none (DLS tints; user pins "a slice top BG, based on transparent galaxy background", "full screen and fixed ... the subtle version of aurora") | scripts/slice-mesh.cjs (OKLab B-spline mesh, random-rounding dither; not image_gen) | 2026-09-25 | active prototype |
| public/return-exp1/ambient/variants/gen_slice-aurora-dark.webp | Ground · slice · aurora, dark — the same on pure black as subtle shades: an indigo crown, violet at the left turning teal at the right, teal down the left edge, violet down the right, a violet bloom behind the message bar; 540×1170, top-anchored cover-fit, pinned, never scrolls | none (DLS tints; user pins "a slice top BG, based on transparent galaxy background", "full screen and fixed ... the subtle version of aurora") | scripts/slice-mesh.cjs (OKLab B-spline mesh, random-rounding dither; not image_gen) | 2026-09-25 | active prototype |
| public/return-exp1/ambient/variants/gen_slice-nebula-light.webp | Ground · slice · nebula, light — a full-screen mesh on the Galaxy's lilac white in the Galaxy's hues: a violet crown, Valentino pink down the left edge, slice blue down the right, a lilac bloom at the foot; 540×1170, top-anchored cover-fit, pinned, never scrolls | none (DLS tints; user pins "a slice top BG, based on transparent galaxy background", "full screen and fixed ... the subtle version of aurora") | scripts/slice-mesh.cjs (OKLab B-spline mesh, random-rounding dither; not image_gen) | 2026-09-25 | active prototype |
| public/return-exp1/ambient/variants/gen_slice-nebula-dark.webp | Ground · slice · nebula, dark — the same on pure black as subtle shades: a violet crown, Valentino down the left edge, slice blue down the right, a violet bloom behind the message bar; 540×1170, top-anchored cover-fit, pinned, never scrolls | none (DLS tints; user pins "a slice top BG, based on transparent galaxy background", "full screen and fixed ... the subtle version of aurora") | scripts/slice-mesh.cjs (OKLab B-spline mesh, random-rounding dither; not image_gen) | 2026-09-25 | active prototype |
